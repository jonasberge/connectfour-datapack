...
execute as @e[tag=connectfour_register2,sort=nearest,limit=1] run execute if entity @s[scores={connectfour_cache=1}] run function connectfour:_set_markers_horizontal
scoreboard players set @e[tag=connectfour_register2,sort=nearest,limit=1] connectfour_cache 0

# Diagonal: Bottom-left to top-right (transform diagonals to horizontals)
function connectfour:_copy_gamestate_to_cache
# keep first column like it is
scoreboard players set @e[tag=connectfour_register2,sort=nearest,limit=1] connectfour_cache 1
scoreboard players operation @e[tag=connectfour_check1,sort=nearest,limit=1] connectfour_cache /= @e[tag=connectfour_register2,sort=nearest,limit=1] connectfour_cache
...
scoreboard players operation @e[tag=connectfour_check2,sort=nearest,limit=1] connectfour_cache /= @e[tag=connectfour_register2,sort=nearest,limit=1] connectfour_cache
# Divide the third column by 4 to move it 2 down
scoreboard players set @e[tag=connectfour_register2,sort=nearest,limit=1] connectfour_cache 4
scoreboard players operation @e[tag=connectfour_check3,sort=nearest,limit=1] connectfour_cache /= @e[tag=connectfour_register2,sort=nearest,limit=1] connectfour_cache
# Divide the fourth column by 8 to move it 3 down
scoreboard players set @e[tag=connectfour_register2,sort=nearest,limit=1] connectfour_cache 8
scoreboard players operation @e[tag=connectfour_check4,sort=nearest,limit=1] connectfour_cache /= @e[tag=connectfour_register2,sort=nearest,limit=1] connectfour_cache
...
scoreboard players set @e[tag=connectfour_register2,sort=nearest,limit=1] connectfour_cache 0
function connectfour:_count_horizontal_row
execute as @e[tag=connectfour_register2,sort=nearest,limit=1] run execute if entity @s[scores={connectfour_cache=1}] run function connectfour:_set_markers_diagonal_bltr
scoreboard players set @e[tag=connectfour_register2,sort=nearest,limit=1] connectfour_cache 0
