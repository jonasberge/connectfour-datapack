...
scoreboard players operation @e[tag=connectfour_register2,sort=nearest,limit=1] connectfour_cache = @e[tag=connectfour_register1,sort=nearest,limit=1] connectfour_cache
