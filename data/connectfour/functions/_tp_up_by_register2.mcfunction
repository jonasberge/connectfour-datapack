execute if entity @e[tag=connectfour_register2,sort=nearest,limit=1,scores={connectfour_cache=1..}] run execute as @e[tag=connectfour_tp_up] at @s run tp @s ~ ~1 ~
...
execute if entity @e[tag=connectfour_register2,sort=nearest,limit=1,scores={connectfour_cache=..0}] run tag @e[tag=connectfour_tp_up] remove connectfour_tp_up
