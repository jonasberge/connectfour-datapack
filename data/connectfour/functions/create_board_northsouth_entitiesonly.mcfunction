...
execute at @e[tag=connectfour_board_origin_live,sort=nearest,limit=1] run summon minecraft:armor_stand ~0 ~1.25 ~ {"Tags":["connectfour_column","connectfour_column4","connectfour_player2_column","connectfour_player2_middle_column"],NoGravity:1b,Invulnerable:1b,NoBasePlate:1b,Small:1b,PersistenceRequired:1b}
