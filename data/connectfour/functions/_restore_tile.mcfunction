...
execute if entity @s[tag=connectfour_player1_column] run execute as @e[tag=connectfour_register2,sort=nearest,limit=1] if entity @s[tag=connectfour_success] run execute as @e[tag=connectfour_placer1,sort=nearest,limit=1] at @s run fill ~ ~ ~ ~ ~ ~ iron_block replace
execute if entity @s[tag=connectfour_player2_column] run execute as @e[tag=connectfour_register2,sort=nearest,limit=1] if entity @s[tag=connectfour_success] run execute as @e[tag=connectfour_placer1,sort=nearest,limit=1] at @s run fill ~ ~ ~ ~ ~ ~ gold_block replace air
